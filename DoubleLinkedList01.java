public class DoubleLinkedList01 {
    ...
    public void print() {
        if (isEmpty()) {
            System.out.println("Linkded list kosong");
        } else {
            Node01 current = head;
    ...
    public void removeFirst() {
        if (isEmpty()) {
            ...
            System.out.println("Data sudah berhasil dihapus. Data yang berhasil dihapus adalah ..." + head.data.nim);
            if (head == tail) {
                head = tail = null;
            } else {
                head = head.next;
    ...
    public void removeLast() {
        if (isEmpty()) {
            ...
            System.out.println("Data sudah berhasil dihapus. Data yang berhasil dihapus adalah ..." +tail.data.nim);
            if (head == tail) {
                head = tail = null;
            } else {
                tail = tail.prev;
    ...
    public void removeAfter(String keyNim) {
        ...
        while (current != null) {
            if (current.data.nim.equals(keyNim)) {
                ...
                size--;
                System.out.println("Node setelah NIM " + keyNim + " berhasil terhapus.");
                return;
            }
            current = current.next;
        }
